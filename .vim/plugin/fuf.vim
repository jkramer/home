...
function s:initialize()
  ...
  call s:defineOption('g:fuf_modes'  , [
        ...
        \ ])
  call s:defineOption('g:fuf_modesDisable'  , [ 'mrucmd', ])
  ...
  "---------------------------------------------------------------------------
  call s:defineOption('g:fuf_mrucmd_prompt'         , '>Command History>')
