...
if version >= 700
  ...
  hi MatchParen    guifg=#d0ffc0 guibg=#202020 gui=bold ctermfg=157 ctermbg=16 cterm=bold
  hi Pmenu 		   guifg=#ffffff guibg=#202020 ctermfg=255 ctermbg=16
  hi PmenuSel 	   guifg=#000000 guibg=#b1d631 ctermfg=0 ctermbg=148
endif

" General colors
hi Cursor 		   guifg=NONE    guibg=#626262 gui=none ctermbg=16
hi Normal 		   guifg=#e2e2e5 guibg=#202020 gui=none ctermfg=253 ctermbg=16
hi NonText 		   guifg=#808080 guibg=#202020 gui=none ctermfg=244 ctermbg=16
hi LineNr 		   guifg=#303030 guibg=#202020 gui=none ctermfg=244 ctermbg=16
